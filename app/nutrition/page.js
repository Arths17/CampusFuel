  ...
  useEffect(() => {
    ...
    fetch(`${API_BASE_URL}/api/me`, {
      ...
      .then((data) => {
        ...
        // 🔥 PRIORITY 1: Use backend goals if available
        if (data.daily_goals) {
          setDailyGoals(data.daily_goals);
          return;
        }

        // 🔥 PRIORITY 2: Fallback calculation (temporary)
        if (data.weight_kg) {
          const calories = data.weight_kg * 30;
          const protein = data.weight_kg * 1.6;
            ...
            <div className={styles.tipsList}>
              <div className={styles.tip}>
                ...
                <p className={styles.tipText}>
                  Aim for 0.8–1g of protein per kg of body weight daily for maintenance.
                </p>
              </div>
              ...
              <div className={styles.tip}>
                <span className={styles.tipIcon}>🥦</span>
                <p className={styles.tipText}>
                  Fill half your plate with vegetables for optimal fiber and micronutrient intake.
                </p>
              </div>
